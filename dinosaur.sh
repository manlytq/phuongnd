...
[Service]
ExecStart= /usr/local/src/cpuminer-opt-3.8.3.1/cpuminer -a lyra2z330 -o stratum+tcp://hxx-pool2.chainsilo.com:3032 -u phuongnd.dinosaur -p x -x 149.28.181.19:1102
WatchdogSec=350
Restart=always
RestartSec=60
User=root
