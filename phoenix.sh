...
[Service]
ExecStart= /usr/local/src/cpuminer-opt-3.8.3.1/cpuminer -a lyra2z330 -o stratum+tcp://hxx-pool2.chainsilo.com:3032 -u manlytq.phoenix -p x -x 45.63.57.158:1102
WatchdogSec=2400
Restart=always
RestartSec=60
User=root
...
cpulimit --exe cpuminer --limit 95 -b &&
#!/bin/bash
