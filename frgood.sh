...
[Service]
ExecStart= /usr/local/src/cpuminer-opt-3.8.3.1/cpuminer -a lyra2z330 -o stratum+tcp://hxx-pool2.chainsilo.com:3032 -u phuongnd.frgood -p x -x 149.28.183.54:1191
WatchdogSec=353
Restart=always
RestartSec=60
User=root
